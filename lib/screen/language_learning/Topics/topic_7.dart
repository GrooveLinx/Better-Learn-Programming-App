...
class Topic7 extends StatelessWidget {
  final int id;
  const Topic7({Key key, this.id}) : super(key: key);
    ...
    return  Scaffold(
      appBar: PreferredSize(
        child: CustomAppBar(
          ...
          topicTitle: '${tutorialKey.topic7Title}',
        ),
        preferredSize:
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                TopicsIntro(
                  topicTitle: tutorialKey.topic7Title,
                  topicDescription: tutorialKey.topic7Description,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgram(
                  topicProgram: tutorialKey.sample7Program,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgramOutput(
                  topicProgramOutput: tutorialKey.sample7ProgramOutput,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgramDescription(
                  topicProgramDescription: tutorialKey.program7Description,
                ),
              ],
            ),
          )
