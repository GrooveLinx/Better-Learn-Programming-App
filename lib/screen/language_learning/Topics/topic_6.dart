...
class Topic6 extends StatelessWidget {
  final int id;
  const Topic6({Key key, this.id}) : super(key: key);
    ...
    return Scaffold(
      appBar: PreferredSize(
        child: CustomAppBar(
          ...
          topicTitle: '${tutorialKey.topic6Title}',
        ),
        preferredSize:
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                TopicsIntro(
                  topicTitle: tutorialKey.topic6Title,
                  topicDescription: tutorialKey.topic6Description,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgram(
                  topicProgram: tutorialKey.sample6Program,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgramOutput(
                  topicProgramOutput: tutorialKey.sample6ProgramOutput,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgramDescription(
                  topicProgramDescription: tutorialKey.program6Description,
                ),
              ],
            ),
          )
