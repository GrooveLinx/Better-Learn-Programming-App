...
class Topic3 extends StatelessWidget {
  final int id;
  const Topic3({Key key, this.id}) : super(key: key);
    ...
    return Scaffold(
      appBar: PreferredSize(
        child: CustomAppBar(
          ...
          topicTitle: '${tutorialKey.topic3Title}',
        ),
        preferredSize:
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                TopicsIntro(
                  topicTitle: tutorialKey.topic3Title,
                  topicDescription: tutorialKey.topic3Description,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgram(
                  topicProgram: tutorialKey.sample3Program,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgramOutput(
                  topicProgramOutput: tutorialKey.sample3ProgramOutput,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgramDescription(
                  topicProgramDescription: tutorialKey.program3Description,
                ),
              ],
            ),
          )
