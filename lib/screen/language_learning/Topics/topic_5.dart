...
class Topic5 extends StatelessWidget {
  final int id;
  const Topic5({Key key, this.id}) : super(key: key);
    ...
    return Scaffold(
      appBar: PreferredSize(
        child: CustomAppBar(
          ...
          topicTitle: '${tutorialKey.topic5Title}',
        ),
        preferredSize:
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                TopicsIntro(
                  topicTitle: tutorialKey.topic5Title,
                  topicDescription: tutorialKey.topic5Description,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgram(
                  topicProgram: tutorialKey.sample5Program,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgramOutput(
                  topicProgramOutput: tutorialKey.sample5ProgramOutput,
                ),
                SizedBox(
                  height: 15,
                ),
                TopicsProgramDescription(
                  topicProgramDescription: tutorialKey.program5Description,
                ),
              ],
            ),
          )
